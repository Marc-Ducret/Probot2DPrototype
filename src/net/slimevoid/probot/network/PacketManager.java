...
public abstract class PacketManager implements Runnable {
    ...
    private void handlePacket(Packet packet) {
        ...
        case 1: // LOGIN
            handleLogin((Packet01Login) packet);
            break;
            
        case 2: // ERROR
        	handleError((Packet02Error) packet);
        	break;
        	
        case 3: // PEER
        	handlePeer((Packet03Peer) packet);
        	break;
        	
		case 4: // PLAY REQUEST
			handlePlayRequest((Packet04PlayRequest) packet);
			break;
    	}
    }

	/**
     * Intéprétation du packet de login
